...
import QuestionsPage2 from './components/QuestionsPage2';
...
function App() {
  ...
  const handleAdminLogin = (token) => {
      // Čuvanje tokena u stanju roditeljske komponente
      setAdminToken(token);
  };
    ...
    <BrowserRouter>
      <Routes>
        ...
        />
                <Route
          path="/questions2"
          element={<QuestionsPage2 handleResult={handleResult} result={result} timeLeftMultiplier={timeLeftMultiplier}difficulty={difficultyVariable} roomName={roomName} username ={username} />}
        />
